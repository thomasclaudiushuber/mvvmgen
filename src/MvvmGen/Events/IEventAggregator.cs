...
{
    /// <summary>
    /// Supports communication between loosely coupled objects
    /// </summary>
    public interface IEventAggregator
    {
        ...
        /// <summary>
        /// Registers an MvvmGen.Events.IEventSubscriber, so that it will receive events from the EventAggregator instance.
        /// </summary>
