...
namespace MvvmGen.SourceGenerators
{
    ...
    {
        [Fact]
        public void GeneratePropertyOfInjectedType()
        {
...
{{   
  ...
  [Inject(typeof(IEmployeeDataProvider),""EmployeeDataProvider""))]
  [ViewModel]
...
");
        ...
        [Fact]
        public void GeneratePropertyWithoutSpecifyingPropertyName()
        {
            ShouldGenerateExpectedCode(
      $@"using MvvmGen;
